...
SLUG="${SLUG%-}"
STACK="kitchen-manager-${SLUG}"

BASE_DOMAIN="${BASE_DOMAIN:-justinthymeapp.com}"
...
IMAGE_WEB="${IMAGE_WEB:-ghcr.io/quillion-systems/kitchen-manager/web:latest}"
IMAGE_API="${IMAGE_API:-ghcr.io/quillion-systems/kitchen-manager/api:latest}"
IMAGE_API_MIGRATE="${IMAGE_API_MIGRATE:-ghcr.io/quillion-systems/kitchen-manager/api-migrate:latest}"
IMAGE_API_SEED="${IMAGE_API_SEED:-ghcr.io/quillion-systems/kitchen-manager/api-seed:latest}"
...
EMAIL_FROM="Kitchen Manager <no-reply@${BASE_DOMAIN}>"
